  ...
  return (
    <div>
      <div className="card home-banner">
        <img src={banners[bannerIndex]} alt={`StyleMate banner ${bannerIndex + 1}`} />
        <button type="button" className="banner-control prev" onClick={handlePrevBanner} aria-label="Previous banner">
          &larr;
        </button>
        <button type="button" className="banner-control next" onClick={handleNextBanner} aria-label="Next banner">
          &rarr;
        </button>
      </div>
